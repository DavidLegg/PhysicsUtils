...
mu_0  = Constant(1.2566370621219e-6, 'mu_0', 'Permeability of free space', HENRY / METER)
eps_0 = Constant(1 / (mu_0 * c**2), 'eps_0', 'Permittivity of free space')
k     = Constant(1/(4*pi*eps_0), 'k', 'Coulomb constant')
h     = Constant(6.62607004e-34, 'h', 'Planck constant', KILOGRAM * METER**2 / SECOND)
hbar  = Constant(h / (2 * pi), 'hbar', 'Reduced Planck constant')
alpha = Constant(k * e**2 / (hbar * c), 'alpha', 'Fine-structure constant')
